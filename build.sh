...
BUILDENV="$BUILDFOLDERPATH/buildfiles/$BuildRelease/$BuildVersion/$BuildEnvironment"
...
mvn -e -Dmaven.test.skip=true -DbuildVersion=$BuildVersion -DbuildRelease=$BuildRelease package
